...
/**
 * Read-only Pokemon Container for Legends: Z-A
 * @see https://github.com/kwsch/PKHeX/blob/master/PKHeX.Core/PKM/PA9.cs
 */
export class PA9 {
    /** @type {ushort} */
    static SIZE = 344;
    ...
    /**
     * @param {ArrayBuffer} buf - An ArrayBuffer containing the raw decrypted pa9 data
     */
    constructor(buf) {
        this.buf = buf;
    ...
    /** @returns {byte} */ get HeightScalar() { return this.dv.getUint8(0x48); }
    /** @returns {byte} */ get WeightScalar() { return this.dv.getUint8(0x49); }
    /** @returns {byte} */ get Scale() { return this.dv.getUint8(0x4a); }
    /** @returns {byte} */ get LevelBoost() { return this.dv.getUint8(0x4b); }
    ...
    /** @returns {int} */ get Status_Condition() { return this.dv.getInt32(0x90, true); }

    /** @returns {byte} */ get TeraTypeOriginal() { return this.dv.getUint8(0x94); }
    /** @returns {byte} */ get TeraTypeOverride() { return this.dv.getUint8(0x95); }
    /** @returns {byte} */ get TeraType() { this.TeraTypeOriginal == this.TeraTypeOverride ? this.TeraTypeOriginal : this.TeraTypeOverride; }
    ...
    /** @returns {byte} */ get Version() { return this.dv.getUint8(0xCE); }
    /** @returns {byte} */ get BattleVersion() { return this.dv.getUint8(0xCF); }

    /** @returns {uint} */ get FormArgument() { return this.dv.getUint32(0xD0, true) >>> 0; }
    ...
    /** @returns {sbyte} */ get AffixedRibbon() { return this.dv.getInt8(0xD4); }

    /** @returns {int} */ get Language() { return this.dv.getUint8(0xD5); }
    ...
    /** @returns {byte} */ get ObedienceLevel() { return this.dv.getUint8(0x11F); }
    ...
    /** @returns {ulong} */ get Tracker() { return this.dv.getBigUint64(0x127, true); }
};