...
/**
 * Read-only Pokemon Container for Brilliant Diamond/Shining Pearl
 * @see https://github.com/kwsch/PKHeX/blob/master/PKHeX.Core/PKM/Shared/G8PKM.cs
 * @see https://github.com/kwsch/PKHeX/blob/master/PKHeX.Core/PKM/PB8.cs
 */
export class PB8 {
    /** @type {ushort} */
    static SIZE = 344;
    ...
    /**
     * @param {ArrayBuffer} buf - An ArrayBuffer containing the raw decrypted pb8 data
     */
    constructor(buf) {
        this.buf = buf;
    ...
    /** @returns {boolean} */ get IsDprIllegal() { return this.dv.getUint8(0x52) != 0; }
