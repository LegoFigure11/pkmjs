...
/**
 * Read-only Pokemon Container for Scarlet/Violet
 * @see https://github.com/kwsch/PKHeX/blob/master/PKHeX.Core/PKM/PK9.cs
 */
export class PK9 {
    /** @type {ushort} */
    static SIZE = 344;
    ...
    /**
     * @param {ArrayBuffer} buf - An ArrayBuffer containing the raw decrypted pk9 data
     */
    constructor(buf) {
        this.buf = buf;
