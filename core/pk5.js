...
/**
 * Read-only Pokemon Container for Black/White (2)
 * @see https://github.com/kwsch/PKHeX/blob/master/PKHeX.Core/PKM/PK5.cs
 */
export class PK5 {
    /** @type {ushort} */
    static SIZE = 220;
    ...
    /**
     * @param {ArrayBuffer} buf - An ArrayBuffer containing the raw decrypted pk5 data
     */
    constructor(buf) {
        this.buf = buf;
    ...
    /** @returns {byte} */ get Nature() { return this.dv.getUint8(0x41); }

    /** @returns {boolean} */ get HiddenAbility() { return (this.dv.getUint8(0x42) & 1) == 1; }

    /** @returns {boolean} */ get NSparkle() { return (this.dv.getUint8(0x42) & 2) == 2; }
    ...
    /** @returns {ushort} */ get EggLocation() { return this.dv.getUint16(0x7e, true); }
    /** @returns {ushort} */ get MetLocation() { return this.dv.getUint16(0x80, true); }
    ...
    /** @returns {byte} */ get Ball() { return this.dv.getUint8(0x83); }
    ...
    /** @returns {byte} */ get PokeStarFame() { return this.dv.getUint8(0x87); }
    
    /** @returns {boolean} */ get IsPokeStar() { return this.PokeStarFame > 250; }
