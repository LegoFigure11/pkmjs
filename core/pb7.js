...
/**
 * Read-only Pokemon Container for Let's Go! Pikachu/Eevee
 * @see https://github.com/kwsch/PKHeX/blob/master/PKHeX.Core/PKM/PB7.cs
 */
export class PB7 {
    /** @type {ushort} */
    static SIZE = 260;
    ...
    /**
     * @param {ArrayBuffer} buf - An ArrayBuffer containing the raw decrypted pb7 data
     */
    constructor(buf) {
        this.buf = buf;
    ...
    /** @returns {boolean} */ get IsFavorite() { return (this.dv.getUint8(0x15) & 8) !== 0; }
    ...
    /** @returns {byte} */ get AV_HP() { return this.dv.getUint8(0x24); }
    /** @returns {byte} */ get AV_ATK() { return this.dv.getUint8(0x25); }
    /** @returns {byte} */ get AV_DEF() { return this.dv.getUint8(0x26); }
    /** @returns {byte} */ get AV_SPE() { return this.dv.getUint8(0x27); }
    /** @returns {byte} */ get AV_SPA() { return this.dv.getUint8(0x28); }
    /** @returns {byte} */ get AV_SPD() { return this.dv.getUint8(0x29); }
    ...
    /** @returns {number} */ get HeightAbsolute() { return this.dv.getFloat32(0x2c, true); }
    ...
    /** @returns {byte} */ get HeightScalar() { return this.dv.getUint8(0x3a); }
    /** @returns {byte} */ get HWightScalar() { return this.dv.getUint8(0x3b); }
    ...
    /** @returns {byte} */ get HT_Intensity() { return this.dv.getUint8(0xa4); }
    /** @returns {byte} */ get HT_Memory() { return this.dv.getUint8(0xa5); }
    /** @returns {byte} */ get HT_Feeling() { return this.dv.getUint8(0xa6); }
    /** @returns {ushort} */ get HT_TextVar() { return this.dv.getUint16(0xa8, true); }
    ...
    /** @returns {byte} */ get ReceivedYear() { return this.dv.getUint8(0xcb); }
    /** @returns {byte} */ get ReceivedMonth() { return this.dv.getUint8(0xcc); }
    /** @returns {byte} */ get ReceivedDay() { return this.dv.getUint8(0xcd); }
    /** @returns {byte} */ get ReceivedHour() { return this.dv.getUint8(0xce); }
    /** @returns {byte} */ get ReceivedMinute() { return this.dv.getUint8(0xcf); }
    /** @returns {byte} */ get ReceivedSecond() { return this.dv.getUint8(0xd0); }
    ...
    /** @returns {number} */ get WeightAbsolute() { return this.dv.getFloat32(0xe4, true); }
