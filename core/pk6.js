...
/**
 * Read-only Pokemon Container for X, Y, Omega Ruby, and Alpha Sapphire
...
export class PK6 {
    ...
    /**
     * @param {ArrayBuffer} buf - An ArrayBuffer containing the raw decrypted pk6 data
     */
    constructor(buf) {
        this.buf = buf;
    ...
    /** @returns {int} */ get AbilityNumber() { return this.dv.getUint8(0x15); }

    /** @returns {int} */ get TrainingBagHits() { return this.dv.getUint8(0x16); }
    ...
    /** @returns {byte} */ get MarkingValue() { return this.dv.getUint8(0x2a); }
    ...
    /** @returns {byte} */ get RibbonCountMemoryContest() { return this.dv.getUint8(0x38); }
    /** @returns {byte} */ get RibbonCountMemoryBattle() { return this.dv.getUint8(0x39); }

    /** @returns {int} */
    get RibbonCount() {
        var part1 = this.Ribbon1 & 0b11111111_11111111_11111111_11111111;
        var part2 = this.Ribbon2 & 0b00000000_00000000_00111111_11111111;
